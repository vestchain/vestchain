...
#include <vestio/producer_api_plugin/producer_api_plugin.hpp>
#include <vestio/chain/exceptions.hpp>
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     vestio::detail::producer_api_plugin_response result{"ok"};
